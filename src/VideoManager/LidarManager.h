...
Q_DECLARE_LOGGING_CATEGORY(LidarManagerLog)

#define MAX_VIDEO_RECEIVERS 2

class FinishLidarInitialization;
...
class LidarManager : public QObject
{
    ...
    friend class FinishLidarInitialization;

public:
    explicit LidarManager(QObject *parent = nullptr);
    ~LidarManager();

    /// Gets the singleton instance of LidarManager.
    ///     @return The singleton instance.
    static LidarManager *instance();
...
class FinishLidarInitialization : public QRunnable
{
public:
    explicit FinishLidarInitialization();
    ~FinishLidarInitialization();
