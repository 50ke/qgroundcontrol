...
public:
    ...
    Q_PROPERTY(LidarManager*        lidarManager            READ    lidarManager            CONSTANT)
    ...
    LidarManager*           lidarManager        ()  { return _lidarManager; }
...
private:
    ...
    LidarManager*           _lidarManager           = nullptr;
#ifndef QGC_AIRLINK_DISABLED
