...
Item {
    ...
    property double _ar:                QGroundControl.lidarManager.gstreamerEnabled
                                            ? QGroundControl.lidarManager.videoSize.width / QGroundControl.lidarManager.videoSize.height
                                            : QGroundControl.lidarManager.aspectRatio
    ...
    property double _thermalHeightFactor: 0.85 //-- TODO
        ...
        Image {
            ...
            visible:        !(QGroundControl.lidarManager.decoding)
    ...
    Rectangle {
        ...
        Component {
            ...
            QGCVideoBackground {
                id:             videoContent
                objectName:     "lidarContent"

                Connections {
                    target: QGroundControl.lidarManager
                    function onImageFileChanged() {
                        videoContent.grabToImage(function(result) {
                            if (!result.saveToFile(QGroundControl.lidarManager.imageFile)) {
                ...
                Rectangle {
                    ...
                    width:  1
                    x:      parent.width * 0.33
                    visible: _showGrid && !QGroundControl.lidarManager.fullScreen
                }
                Rectangle {
                    color:  Qt.rgba(1,1,1,0.5)
                    height: parent.height
        ...
        Item {
            id:                 thermalItem
            width:              height * QGroundControl.lidarManager.thermalAspectRatio
            ...
            anchors.centerIn:   parent
            visible:            QGroundControl.lidarManager.hasThermal && _camera.thermalMode !== MavlinkCameraControl.THERMAL_OFF
            function pipOrNot() {
                if(_camera) {
