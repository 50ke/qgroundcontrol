...
Item {
    ...
    PipState {
        ...
        onWindowAboutToOpen: {
            QGroundControl.lidarManager.stopVideo()
        ...
        onStateChanged: {
            if (pipState.state !== pipState.fullState) {
                QGroundControl.lidarManager.fullScreen = false
            }
        }
    }
    ...
    Timer {
        ...
        running:      false
        repeat:       false
        onTriggered:  QGroundControl.lidarManager.startVideo()
    }

    //-- Video Streaming
    FlightDisplayViewLidar {
        id:             videoStreaming
        anchors.fill:   parent
        useSmallFont:   _root.pipState.state !== _root.pipState.fullState
        visible:        QGroundControl.lidarManager.isStreamSource
    }
    //-- UVC Video (USB Camera or Video Device)
    Loader {
        id:             cameraLoader
        anchors.fill:   parent
        visible:        QGroundControl.lidarManager.isUvc
        source:         QGroundControl.lidarManager.uvcEnabled ? "qrc:/qml/FlightDisplayViewUVC.qml" : "qrc:/qml/FlightDisplayViewDummy.qml"
    }

    QGCLabel {
        text: qsTr("Double-click to exit full screen")
        font.pointSize: ScreenTools.largeFontPointSize
        visible: QGroundControl.lidarManager.fullScreen && flyViewVideoMouseArea.containsMouse
    ...
    MouseArea {
        ...
        onDoubleClicked: QGroundControl.lidarManager.fullScreen = !QGroundControl.lidarManager.fullScreen
